...
const OurTeams = () => {
    ...
    return (
        <div>
            ...
            <h1 className="text-3xl font-bold text-center mt-12">Our Honorable Teams</h1>
                ...
                <div className="max-w-6xl px-6 py-12 mx-auto">
                    <main className="relative z-20 w-full mt-8 md:flex md:items-center xl:mt-12">
                        ...
                        <div className="w-full p-6 bg-gray-700 md:flex md:items-center rounded-2xl md:bg-transparent md:p-0 lg:px-12 md:justify-evenly">
                            <img className="h-24 w-24 md:mx-6 rounded-full object-cover shadow-md md:h-[30rem] md:w-72 lg:h-[32rem] lg:w-[22rem] md:rounded-2xl" src={Jabir} alt="" />
