  ...
  return (
    <div className="card w-96 bg-base-100 shadow-xl my-16">
      <div className="card-body">
        ...
        <h2 className="text-green-600">
          Purchase Year: <span className="text-black">{purchaseYear}</span>
        </h2>
        <h2 className="text-green-600">
          Original Price: <span className="text-black">${originalPrice}</span>
        </h2>
        <h2 className="text-green-600">
          Resale Price:{" "}
          <span className="text-red-400 font-bold">${resalePrice}</span>
        </h2>
        <h2 className="text-green-600">
          Use Year: <span className="text-black">{useYear}</span>
        </h2>
        <h2 className="text-green-600">
