      ...
      <div className="flex">
        <div className="flex flex-col md:flex-row md:max-w-3xl md:h-36 my-2 rounded-lg bg-white shadow-lg">
          ...
          <div className="px-6 flex flex-col justify-start">
            ...
            <p className="text-gray-500 text-xs mb-2">Feb 14th - Feb 15th</p>
            <button className="bg-gray-500 text-slate-50 mt-1 py-2">
              Join Now
            </button>
          </div>
        </div>
...
export default SellerAvailableCampaign;
